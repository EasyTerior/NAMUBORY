			...
			<div id="carouselExampleCaptions" class="carousel slide carousel-fade carousel-dark mt-5" data-bs-ride="carousel">
			    ...
			    <div class="carousel-inner">
			        <div class="carousel-item active" data-bs-interval="3000">
			            ...
			            <a href="#" class="d-block w-50 float-end"><img class="d-block w-100" src="${ contextPath }/resources/common/styleRoom.jpg" alt="styleRoom"></a>
			        </div>
			        <div class="carousel-item" data-bs-interval="3000">
			            ...
			            <a href="#" class="d-block w-50 float-end"><img class="d-block w-100" src="${ contextPath }/resources/common/colorChange.jpg" alt="colorChange"></a>
			        </div>
			        <div class="carousel-item" data-bs-interval="3000">
			        	<div class="d-block w-50 float-start mt-5 text-center">
			            ...
			            <a href="#" class="d-block w-50 float-end"><img src="${ contextPath }/resources/common/community.jpg" class="d-block w-100" alt="community"></a>
			        </div>
			    </div>
