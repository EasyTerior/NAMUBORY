						...
						<c:choose>
							<c:when test="${not empty board.boardImage2}">
								...
								<div class="col-md-6">
									<div class="image-container">
										<img
											src="${pageContext.request.contextPath}/resources/upload/${board.boardImage2}"
											alt="image">
									</div>
								</div>
							</c:when>
						...
						<c:choose>
							<c:when test="${not empty board.boardImage4}">
								<div class="col-md-6">
									<div class="image-container">
										<img
											src="${pageContext.request.contextPath}/resources/upload/${board.boardImage3}"
											alt="image">
									</div>
								</div>
								<div class="col-md-6">
									<div class="image-container">
										<img
											src="${pageContext.request.contextPath}/resources/upload/${board.boardImage4}"
											alt="image">
									</div>
								</div>
							</c:when>
